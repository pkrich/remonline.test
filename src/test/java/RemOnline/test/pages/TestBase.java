...
import RemOnline.test.util.PropertyLoader;
import RemOnline.test.util.Browser;
import RemOnline.test.webdriver.WebDriverFactory;
...
//	}
	...
	{
		openPage();
		return (driver.findElement(By.xpath("//li[5]/span")).getSize() != null);
	}
}
